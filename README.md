...
- **Hero glass object** — Interactive WebGL glass bolt (drag to orbit) refracting the headshot behind it, replacing the flat portrait; falls back to the plain photo if WebGL is unavailable
